...
public class ViewerController {
	...
	public String ViewerMain(String booknumber, Model model, HttpServletRequest request, HttpSession session) throws ParserConfigurationException, SAXException, IOException {
		String path = null;
